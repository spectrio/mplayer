...
var defaultArgs = ['-msglevel', 'global=6', '-msglevel', 'cplayer=4', '-idle', '-xy 1280', '-geometry 50%:50%', '-slave', '-noborder'];
...
Player.prototype = _.extend({
    spawn: function() {
        ...
        var ags = defaultArgs.concat(args);
        //console.log("mplayer args: " + ags);
        //alert(ags)
        var instance = spawn('mplayer', ags);
